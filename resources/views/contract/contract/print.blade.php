<x-app-layout>
                    ...
                    <div class="print-container a4-width mx-auto  bg-white">
                        <div class="p-4" style="font-family: 'Arial', sans-serif;">
                            ...
                            <div style="text-align: right; margin: 0.8rem auto; font-size: 0.9rem; font-weight: bold;">
                                <p>الطرف الأول/ شركة بوابة العلم للمقاولات والتجارة العامة والاستثمارات العقارية محدودة
                                    المسؤولية ويمثلها المدير
                                    المفوض /
                                    اضافة الى وظيفته. </p>
                            </div>
                            <div style="text-align: right; margin: 0.8rem auto; font-size: 0.9rem; font-weight: bold;">
                            ...
                            <div style="text-align: right; margin: 0.8rem auto; font-size: 0.9rem; font-weight: bold;">
                                <p>
                                    ...
                                    الاستثمارية المرقمة (318) لسنة 2024/2/18 والصادرة من هيئة استثمار النجف .
                            ...
                            <div style="text-align: right; margin: 0.8rem auto; font-size: 0.9rem; font-weight: bold;">
                                <p>في حالة رغبة الطرف الثاني الاستفاده من قرض مصرفي على الوحده السكنية وتسديدها الى
                                    ...
                                    يقابله من مبلغ الدفعات المذكوره في الفقره رابعاً من الية تسديد بدل شراء
                                ...
                                <p>
                                    ...
                                    <br> 2- يلتزم الطرف الثاني بدفع ثمن الوحدة السكنية المشار لها في ( البند
                                    ...
                                    أو أي رسوم أخرى.
                                    @if ($contract->contract_payment_method_id == 3)
                                        <br> 7- في حالة تسليم الوحدة السكنية الى الطرف الثاني قبل تسديد كامل الاقساط
                                        يلتزم
                                        الطرف الثاني بتسديد دفعة المفتاح مع استمرار الدفعات المتبقية .
                                    @endif
                                ...
                                <p>
                                    ...
                                    التحريرية من الطرف الاول و اجور الخدمات المحددة في الملحق رقم 3 ومصاريف الصيانة
                                    وكافة التزا اماته المالية
                                    الناشئة عن هذا العقد الى الطرف الأول . ويقع باطلاً أي تصرف يخالف ذلك ،
                                    ...
                                    <br> 15- في حالة تاخر الطرف الثاني عن التسديد المدرج في الفقره (رابعاً) من الية
                                ...
                                <p>
                                    ...
                                    <br>1- يتحقق الانفساخ التلقائي عند تحقق احد الشروط الواردة في الفقرة (16) من
                            ...
                            <div style="text-align: right; margin: 0.8rem auto; font-size: 0.9rem; font-weight: bold;">
                                <p>
                                    ...
                                    والتعليمات والأنظمة القانونية النافذة في العراق، ويطبق عليه الفقرة (عاشراً / 1)
    ...
    <script>
        function convertNumbersToArabic() {
            ...
            walk(document.body); // Start with the body element
        }

        // Run the conversion after the DOM content is fully loaded
