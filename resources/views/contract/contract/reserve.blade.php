                            ...
                            <div class="mx-1 my-1">
                                ...
                                <div class="my-1">
                                    ...
                                    <p style=" font-size: 0.85rem;">
                                        ...
                                        لشراء
                                        الوحدة السكنية .
                                        <br> 3- يحظر على المشتري التنازل عن استمارة حجز الوحدة السكنية للغير ويعد
                                        التنازل
                                        باطلا
                                        ...
                                        الشركة او من قبل الزبون يتم استقطاع مبلغ (

                                        @if ($contract->building->building_category_id == 1)
                                            {{ number_format(2500000, 0) . ' دينار ' }}
                                        @elseif ($contract->building->building_category_id == 2)
                                            {{ number_format(4000000, 0) . ' دينار ' }}
                                        @elseif ($contract->building->building_category_id == 3)
                                            {{ number_format(2000000, 0) . ' دينار ' }}
                                        @elseif ($contract->building->building_category_id == 4)
                                            {{ number_format(3500000, 0) . ' دينار ' }}
                                        @elseif ($contract->building->building_category_id == 5)
                                            {{ number_format(2000000, 0) . ' دينار ' }}
                                        @endif
                                        ...
                                        المحاكم المختصة
                                        <br> 9- في حال تم استبدال رقم الهاتف الخاص بالزبون يتم اشعار الادارة .
                                    </p>
                                </div>
