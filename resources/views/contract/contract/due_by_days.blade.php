                                ...
                                <tbody>
                                    ...
                                    @foreach ($installments as $ins)
                                        @php
                                            ...
                                            $message .= "💰 المبلغ المتبقي: {$remainingAmount} دينار\n";
                                            ...
                                            if ($dueDays > 0) {
                                                ...
                                                $message .=
                                                    "نرجو التفضل بتجهيز المبلغ المستحق والالتزام بموعد الدفع المحدد.\n\n";
                                            } else {
                                                // مستحق اليوم
                                                $message .= "⏰ القسط مستحق اليوم\n\n";
                                                $message .=
                                                    "نرجو التفضل بمراجعة الإدارة لدفع القسط المستحق في أقرب وقت ممكن.\n\n";
                                            }
