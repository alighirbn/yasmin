            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ route('contract.update', $contract->url_address) }}">
                        ...
                        <input type="hidden" name="url_address" value="{{ $contract->url_address }}">
                        ...
                        <div class="flex">
                            ...
                            <div class="mx-4 my-4 w-full">
                                ...
                                <x-text-input id="contract_date" class="w-full block mt-1" type="text"
                                    name="contract_date" value="{{ old('contract_date', $contract->contract_date) }}"
                        ...
                        <div id="variable-payment-fields" class="hidden">
                            ...
                            <div class="flex">
                                ...
                                <div class="mx-4 my-4 w-full">
                                    ...
                                    <select id="deferred_type" name="deferred_type" class="w-full block mt-1">
                                        <option value="none"
                                            {{ old('deferred_type', $contract->deferred_type ?? 'none') == 'none' ? 'selected' : '' }}>
                                            {{ __('word.none') }}</option>
                                        <option value="spread"
                                            {{ old('deferred_type', $contract->deferred_type ?? 'none') == 'spread' ? 'selected' : '' }}>
                                ...
                                <div class="mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="deferred_months" class="w-full block mt-1" type="number"
                                        ...
                                        value="{{ old('deferred_months', $contract->deferred_months ?? 0) }}"
                                        min="0" />
                        ...
                        <div class="mx-4 my-4 w-full">
                            ...
                            <x-text-input id="contract_note" class="w-full block mt-1" type="text"
                                name="contract_note" value="{{ old('contract_note', $contract->contract_note) }}" />
                            <x-input-error :messages="$errors->get('contract_note')" class="w-full mt-2" />
                        </div>

                        <!-- Submit -->
                        <div class="mx-4 my-4 w-full">
                            <x-primary-button id="contract-submit" class="ml-4">
                                {{ __('word.save') }}
                            </x-primary-button>
                        </div>
                    </form>
