                            ...
                            <tbody>
                                ...
                                @foreach ($deptPayrolls as $payroll)
                                    ...
                                    <tr class="{{ $loop->even ? 'bg-gray-50' : '' }}">
                                        ...
                                        <td class="border px-2 py-1">{{ number_format($payroll->basic_salary, 0) }}</td>
                                        <td class="border px-2 py-1">{{ number_format($payroll->total_incentives, 0) }}
                                        </td>
                                        <td class="border px-2 py-1">
                                            {{ number_format($payroll->total_deductions - $advancesTotal, 0) }}</td>
