                                    ...
                                    <select id="classification_id" class="w-full block mt-1 " name="classification_id">
                                        @foreach ($classifications as $classification)
                                            <option value="{{ $classification->id }}"
                                                {{ (old('classification_id') ?? $building->classification_id) == $classification->id ? 'selected' : '' }}>
                                                {{ $classification->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="flex">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="building_real_area" class="w-full block mt-1" type="text"
                                        name="building_real_area"
                                        value="{{ old('building_real_area') ?? $building->building_real_area }}" />
